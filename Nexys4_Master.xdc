...
#set_property PACKAGE_PIN V9 [get_ports {btn[0]}]					
    #set_property IOSTANDARD LVCMOS33 [get_ports {btn[0]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {btn[1]}]					
...
#set_property PACKAGE_PIN R2 [get_ports {y[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {y[14]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {y[15]}]					
